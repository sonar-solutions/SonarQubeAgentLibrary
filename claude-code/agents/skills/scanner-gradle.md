...
**Step 3:** ⛔ STOP — Get the latest plugin version.
...
```bash
python3 <SCRIPT_PATH>/fetch-sonar-config.py --platform <platform> --scanner-approach gradle --sonarqube-type <cloud|server>
```
